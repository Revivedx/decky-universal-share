...
- **Share options panel**: three blocks. **QR Link** sets how long a "Share via QR" link stays active before expiring on its own (1/5/10/30 minutes). **Google Drive** and **Discord** are collapsible; each holds its Link/Unlink button and, once linked, its Auto-upload toggle and upload-delay slider.
